...
public class Main {
    private static final int MAX_PASSWORD_LENGTH = 20; // MAX длина пароля (слова + числа).
    private static final int MAX_NUMBER = 9999; // MAX число для численной части пароля.

    private static final String DICTIONARY_FILE = "10k-most-common.txt"; // Путь к файлу со словарем.

    public static void main(String[] args) {
        long targetHash = 0x0BA02B6E1L; // Заменить на ваш CRC32 хеш исходного пароля.
